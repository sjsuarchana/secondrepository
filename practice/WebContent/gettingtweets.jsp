<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
 <%@ page import="java.net.HttpURLConnection,java.io.*,java.lang.*,org.kuuma.jsp.*" %>   
...
<button type="button" onclick="location = 'followSelena.jsp'" name="followElon">Follow Elon Musk</button>
